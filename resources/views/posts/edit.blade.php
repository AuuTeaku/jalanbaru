                        ...
                        <form action="{{ route('post.update', $post->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select name="category" class="form-control" required>
                                    <option value="1" {{ $post->category == 1 ? 'selected':'' }}>Politik</option>
                                    <option value="2" {{ $post->category == 2 ? 'selected':'' }}>Ekonomi</option>
                                    <option value="3" {{ $post->category == 3 ? 'selected':'' }}>Sosial</option>
                                    <option value="4" {{ $post->category == 4 ? 'selected':'' }}>Lingkungan</option>
                                    <option value="5" {{ $post->category == 5 ? 'selected':'' }}>Pendidikan</option>
