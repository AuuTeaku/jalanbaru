        ...
        <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
            <div class="container-fluid">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="/lingkungan">Lingkungan</a></li>
                                    ...
                                    <div class="col-lg-6 border" style="max-height: 700px">
                                        <div class="position-relative mb-3 bg-light">
                                            ...
                                            <div class="overlay position-relative bg-white">
                                                ...
                                                <a class="h4" href="{{ route('post.show', $p->id) }}">{{ $p->title }}</a>
                            ...
                            <div class="w3-bar">
                                @if (isset($post))
                                    @if ($post->currentPage() > 1)
                                        <a href="{{ $post->previousPageUrl() }}"><button class="w3-button w3-left w3-light-grey">&laquo; Previous</button></a>
                                    @endif

                                    @if ($post->hasMorePages())
                                        <a href="{{ $post->nextPageUrl() }}"><button class="w3-button w3-right w3-green">Next &raquo;</button></a>
                                    @endif
                                @endif
                            </div>
                        </div>
